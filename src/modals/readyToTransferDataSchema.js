...
const readyToTransferDataSchema = new mongoose.Schema({
clientName:{
...
const ReadyToTransferData = mongoose.model("ReadyToTransferData",readyToTransferDataSchema);

module.exports = ReadyToTransferData;
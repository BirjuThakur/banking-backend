...
const feAllocationPendingCaseSchema = new mongoose.Schema({
clientName:{
...
const FeAllocationPending = mongoose.model("FeAllocationPending",feAllocationPendingCaseSchema);

module.exports = FeAllocationPending;
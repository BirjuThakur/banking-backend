...
const caseClosedSchema = new mongoose.Schema({
    name:{type:String},
    email:{type:String},
...
//password hashing 
caseClosedSchema.pre("save", async function (next) {
...
caseClosedSchema.methods.generateToken = async function () {
    try {
...
const CaseClosed = mongoose.model("CaseClosed",caseClosedSchema);

module.exports = CaseClosed;
